 ...
 *
 * So, do not write your TFID Analyzer tests in this file.
 * Create a separate test file TfIdfAnalyzer.java to write your tests.
 */

public class TestProvidedTfIdfAnalyzer extends BaseTest {
